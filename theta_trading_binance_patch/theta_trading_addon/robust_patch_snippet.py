...
def resolve_symbols_to_csv(symbols, interval, limit=2000, outdir="prices"):
    """Mix: tickery i CSV cesty -> vrať CSV cesty. Pokud CSV chybí, stáhni je přes make_prices_csv.py (Binance/ccxt)."""
