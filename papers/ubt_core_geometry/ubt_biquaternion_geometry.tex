...
where $\mathrm{Sc}$ denotes the scalar (real) part of the biquaternion product.

Equivalently, using the full biquaternion product:
...
The connection is defined through the compatibility condition with the tetrad:
